...
<div class="title">Wenn wir die KI blind übernehmen.</div>
<div class="sub">1 372 Personen lösen Urteilsaufgaben — einmal allein, einmal mit KI-Vorschlag.<br>Ist der KI-Vorschlag richtig, werden sie um <strong>+25 %-Punkte</strong> korrekter.<br>Ist er falsch, sind sie um <strong>−15 %-Punkte</strong> schlechter.<br>Die meisten übernehmen, ohne zu prüfen.</div>
<div class="nums">Shaw &amp; Nave (2026) · Wharton · 9 593 Trials</div>
</div>
</div>
...
<li><strong>Welche Entscheidungen</strong> müssen Sie vor dem Einsatz von KI treffen?</li>
</ol>
...
## Warum Analog-first? — Zwei empirische Befunde
...
<div style="margin-top: 1em; padding: 0.7rem 1rem; background: rgba(0,0,0,0.03); border-radius: 8px; font-size: 0.9em; color: #555;">
<strong>Konsequenz:</strong> analog planen und strukturieren → KI als zweite Stimme für Variation und Rückmeldung → begründet übernehmen oder verwerfen.
</div>
...
## Vor der Umsetzung — zwei Entscheidungen
